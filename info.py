...
BOT_TOKEN = environ.get('BOT_TOKEN', "7879303252:AAE7PfHvDcNYIyXpCiT3zoOb8JsubsKNgh4")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002386306695').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://razith143143:abdul@786@cluster0.pk5zp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/allinonetamil66')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/All_In_One_Linkz')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/chat_sup_6') # Support Chat Link Without https:// or @
